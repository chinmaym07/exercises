...
describe('Author With Most Likes',() => {
  ...
  test('of empty List is zero',() => {
    const result = listHelper.mostLikesOnAnAuthorBlog(emptyList);
    expect(result).toEqual({});
  });

  test('when list has only one blog, equals the author & likes on that',() => {
    const result = listHelper.mostLikesOnAnAuthorBlog(listWithOneBlog);
    expect(result).toEqual({
      author: 'Edsger W. Dijkstra',
      likes:5
    });
  ...
  test('of a bigger list is calculated right',() => {
    const result = listHelper.mostLikesOnAnAuthorBlog(listWithManyBlogs);
    expect(result).toEqual({
      author: "Edsger W. Dijkstra",
      likes: 17
    });
